export default function ProductCard({
  ...
  return (
    <div className="flex w-full flex-1 basis-96 flex-col gap-5 rounded-2xl p-6 outline outline-2 -outline-offset-2 outline-lime-200/20 transition-colors duration-200 hover:outline-lime-200">
