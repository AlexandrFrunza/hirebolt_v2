...
const networkStats = [
  { icon: "/hire-ai-talent/icon-globe.png", label: "40 regions / timezones" },
  {
    icon: "/hire-ai-talent/icon-hourglass.png",
    label: "48hrs average time to first shortlist",
  },
  {
    icon: "/hire-ai-talent/icon-globe.png",
...
export default function NetworkSection() {
  return (
    <section className="py-28">
      <Container>
        <div className="flex flex-col items-center gap-12 rounded-2xl border-2 border-lime-200 px-6 py-16 text-center sm:px-16">
